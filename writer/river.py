...
class River(Scene):
    def __init__(self, screen, effects=[], duration=600, clear=True, name='River'):
        super().__init__(effects, duration, clear, name)
        self._screen = screen
        self.car_text = resource_string('writer.art', 'river').decode('utf-8')
    ...
    def process_event(self, event):
        super(River, self).process_event(event)
