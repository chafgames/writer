...
class Intro2(Scene):
    def __init__(self, screen, effects=[], duration=400, clear=True, name='Intro'):
        ...
        self.story_text2 = "Jenny’s writing has kept her sane since the Cold War ended. Left by the UK government to cope with the trauma of being an ex-spy."
        self.story_text3 = "She has alienated her family in service to her country, and now that her country has abandoned her, she’s trying to find her way back to normal life."
        self.story_text4 = "When she’s hears the news she’s been waiting for, she falls into a coma, and words are the only thing that can bring her back to reality."
